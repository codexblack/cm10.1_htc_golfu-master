...
# Camera
PRODUCT_COPY_FILES += \
    vendor/htc/golfu/proprietary/lib/hw/camera.default.so:system/lib/hw/vendor-camera.default.so \
    ...
    vendor/htc/golfu/proprietary/lib/libmmjpeg.so:obj/lib/libmmjpeg.so \
...
# Wifi
PRODUCT_COPY_FILES += \
    device/htc/golfu/prebuilt/etc/firmware/fw_bcm4330_b2.bin:system/etc/firmware/fw_bcm4330_b2.bin \
    device/htc/golfu/prebuilt/etc/firmware/fw_bcm4330_apsta_b2.bin:system/etc/firmware/fw_bcm4330_apsta_b2.bin \
    device/htc/golfu/prebuilt/etc/firmware/fw_bcm4330_p2p_b2.bin:system/etc/firmware/fw_bcm4330_p2p_b2.bin \
...
# Misc Blobs
PRODUCT_COPY_FILES += \
    device/htc/golfu/prebuilt/bin/bma150_usr:system/bin/bma150_usr \
    device/htc/golfu/prebuilt/bin/htc_ebdlogd:system/bin/htc_ebdlogd \
    device/htc/golfu/prebuilt/bin/logcat2:system/bin/logcat2 \
